...
class AccountInvoice(models.Model):
    ...
    def _onchange_fiscal_position_id(self):
        _logger.warning('tax_auto_onchange_fiscal_position_id')
   ...
   #     return invoice
    ...
    def addAutoTax(self):
        _logger.warning('addAutoTax')
        tax_auto_ids = self.env['account.tax'].search([('auto_tax', '=', True),('type_tax_use', '=', self.journal_id.type)])
